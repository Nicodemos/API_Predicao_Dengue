...
for i in range(4,5):
    ...
    # Padroniza os dados de treino, padronização e diferente de normalização, na pratica tentam resolver o mesmo problema
    ...
    all_dta_to_graf['Predito'].plot(linestyle='dashed',color="#696969",fontsize=12)
    all_dta_to_graf['Real'].plot(linestyle='solid',color="#4F4F4F",fontsize=12)
    plt.tight_layout()
